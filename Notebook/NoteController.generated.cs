...
namespace Notebook.Controllers
{
    public partial class NoteController
    {
        ...
        public class ActionParamsClass_Create
        {
            ...
            public readonly string hiddenTags = "hiddenTags";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Note/Create.cshtml";
            public readonly string Search = "~/Views/Note/Search.cshtml";
            public readonly string Single = "~/Views/Note/Single.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_NoteController : Notebook.Controllers.NoteController
    {
        ...
        [NonAction]
        public override System.Web.Mvc.ActionResult Search(Notebook.Models.Note.SearchNoteVM filter)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Search);
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int noteId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(int noteId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "noteId", noteId);
            DeleteOverride(callInfo, noteId);
            return callInfo;
        }
